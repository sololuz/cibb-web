    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_email', models.EmailField(max_length=75, null=True, verbose_name='new email address', blank=True)),
                ('email_token', models.CharField(default=None, max_length=200, null=True, verbose_name='email token', blank=True)),
                ('token', models.CharField(default=None, max_length=200, null=True, verbose_name='token', blank=True)),
